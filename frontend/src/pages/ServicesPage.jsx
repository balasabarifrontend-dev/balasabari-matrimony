...
//       <h1 className="text-3xl font-bold text-center mb-8 text-red-700">Our Services</h1>
//       <div className="grid md:grid-cols-3 gap-6">
//         {services.map((s) => (
//           <div key={s.id} className="border p-6 rounded-lg shadow hover:shadow-lg bg-white">
