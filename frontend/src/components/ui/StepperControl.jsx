...
//   return (
//     <div className="flex justify-between items-center gap-4 pt-6 mt-6 border-t border-gray-200">
    ...
    <div className="flex justify-between items-center gap-4 pt-6 mt-6 border-t border-gray-200">
      ...
      <div className="flex-1">
        <button
          ...
          className={`w-full min-w-[120px] px-6 py-3 font-medium rounded-lg border transition-colors duration-200 shadow-sm
            ${isFirstStep 
              ? "invisible" 
              : "text-gray-800 bg-white border-gray-300 hover:bg-gray-50 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"}`
          }
        >
          <span className="flex items-center justify-center text-gray-800">
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
