...
//         <img
//           src={profile.image}
//           alt={profile.user?.name || profile.fullName || profile.name}
...
//           {profile.user?.name?.[0] || profile.fullName?.[0] || profile.name?.[0] || "?"}
//         </div>
//       )}

//       <h4 className="mt-3 font-semibold text-gray-800">
//         {profile.user?.name || profile.fullName || profile.name}
//       </h4>
...
//           (profile.user?.gender || profile.gender) === "Female"
//             ? "bg-pink-100 text-pink-700"
//             : "bg-blue-100 text-blue-700"
//         }`}
//       >
//         {profile.user?.gender || profile.gender}
//       </span>
//     </div>
//   );
// }
